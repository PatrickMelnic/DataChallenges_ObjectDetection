...
MODEL_SAVE_PATH = 'models/vithybrid_100_1_multilabel.pth'
MODEL_SAVE_DIR = 'models/vithybrid_100_1/'
NUM_EPOCHS = 15
BATCH_SIZE = 32
LEARNING_RATE = 5e-5
...
plt.savefig('vithybrid_100_1_validation_accuracy.png')
...
plt.savefig('vithybrid_100_1_validation_f1_score.png')
