...
MODEL_SAVE_PATH = 'models/deit_multilabel.pth'
MODEL_SAVE_DIR = 'models/deit/'
NUM_EPOCHS = 25
BATCH_SIZE = 32
LEARNING_RATE = 5e-5
...
config = DeiTConfig.from_pretrained("facebook/deit-base-distilled-patch16-224", num_labels=num_labels)
model = DeiTForImageClassification.from_pretrained("facebook/deit-base-distilled-patch16-224", config=config, ignore_mismatched_sizes=True)
