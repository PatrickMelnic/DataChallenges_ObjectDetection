...
model_path1 = "models/vithybrid_0_1/"
...
with open('class_index_mapping_0.json', 'r') as file:
...
plt.xlabel('Labels')
plt.ylabel('Labels')
plt.savefig('0_cooccurence.png', dpi=300, bbox_inches='tight')  # Saves the heatmap as a PNG file
...
# Save the figure
plt.savefig('0_heatmap.png', dpi=300, bbox_inches='tight')  # Saves the heatmap as a PNG file
plt.close()  # Close the plot to free up memory

print("Heatmap saved as 'heatmap.png'")
# Save results to a JSON file
with open('0_results.json', 'w') as json_file:
...
plt.xlabel('Labels')
plt.ylabel('Labels')
plt.savefig('0_co_occurrence_heatmap.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.xlabel('Predicted Labels')
plt.ylabel('True Labels')
plt.savefig('0_agreement_heatmap.png', dpi=300, bbox_inches='tight')
plt.close()
...
with open("analysis_0.txt", "w") as file:
...
# Open a file to write the analysis
with open("0_analysis.txt", "w") as file:
    def print_and_save(message):
        print(message)
        file.write(message + "\n")
