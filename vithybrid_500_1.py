...
DATASET_PATH = 'datasets/multilabel_500'
CLASS_MAPPING_FILE = 'class_index_mapping_500.json'
MODEL_SAVE_PATH = 'models/vithybrid_500_1_multilabel.pth'
MODEL_SAVE_DIR = 'models/vithybrid_500_1/'
NUM_EPOCHS = 15
BATCH_SIZE = 32
LEARNING_RATE = 5e-5
...
plt.savefig('vithybrid_500_1_validation_accuracy.png')
...
plt.savefig('vithybrid_500_1_validation_f1_score.png')
