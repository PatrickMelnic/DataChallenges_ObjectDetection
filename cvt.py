...
MODEL_SAVE_PATH = 'models/cvt_multilabel.pth'
MODEL_SAVE_DIR='models/cvt/'
NUM_EPOCHS = 25
BATCH_SIZE = 32
LEARNING_RATE = 5e-5
...
config = CvtConfig.from_pretrained('microsoft/cvt-21', num_labels=num_labels)
model = CvtForImageClassification.from_pretrained('microsoft/cvt-21', config=config, ignore_mismatched_sizes=True)
