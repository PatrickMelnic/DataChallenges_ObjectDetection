#VitHybrid mit 500 Limit für Klassen und normalem Training
import os
import pandas as pd
import json
...
DATASET_PATH = 'datasets/multilabel_1000'
CLASS_MAPPING_FILE = 'class_index_mapping_1000.json'
MODEL_SAVE_PATH = 'models/vithybrid_1000_1_multilabel.pth'
MODEL_SAVE_DIR = 'models/vithybrid_1000_1/'
NUM_EPOCHS = 15
BATCH_SIZE = 32
LEARNING_RATE = 5e-5
...
plt.savefig('vithybrid_1000_1_validation_accuracy.png')
...
plt.savefig('vithybrid_1000_1_validation_f1_score.png')
