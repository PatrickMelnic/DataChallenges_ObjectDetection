...
from transformers import TrainingArguments, Trainer, OwlViTProcessor, OwlViTForObjectDetection
...
saved_dataset_path = "datasets/obj_det/" #cached dataset
model_name = "openai/owlvit-base-patch32"
output_dir = "temp/"
final_model_save_path = "owl_vit_model/"
...
def preprocess_function(examples):
    inputs = processor(text=examples["label"], images=examples["image"], return_tensors="pt", padding="max_length", max_length=77, truncation=True)
    return inputs
