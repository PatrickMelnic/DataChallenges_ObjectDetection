...
MODEL_SAVE_PATH = 'models/vithybrid3_multilabel.pth'
MODEL_SAVE_DIR = 'models/vithybrid3/'
NUM_EPOCHS = 25
BATCH_SIZE = 32
LEARNING_RATE = 5e-5
...
for sample in train_dataset:
    labels.append(sample['encoded_label'])

labels = np.array(labels)
class_weights = compute_class_weight('balanced', np.unique(labels.flatten()), labels.flatten())
