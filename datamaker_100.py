...
data_save_dir = 'datasets/multilabel_100/'
transformed_data_save_dir = 'datasets/transformed_multilabel/'
limiter = 100  # Minimum number of images per class
...
def visualize_data_distribution(dataset_dict, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, '100_images_per_class.png'))
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, '100_labels_per_image.png'))
    plt.close()
...
def main():
    ...
    class_mapping_file = 'class_index_mapping_100.json'
